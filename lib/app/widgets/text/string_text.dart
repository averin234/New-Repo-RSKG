...
class CustomStringText {
  ...
  String DetailAntrean = "Detail Antrean";
  String PilihKunjungan = "Pilih tanggal & Waktu Kunjungan";
  ...
  String CariDokter = "Mohon Cari Dokter Lain atau Pilih tanggal yang berbeda";
  String RiwayatPasien = "Riwayat Pasien";
  String EditProfile = "Edit Profile";
  String Antreanaatini = "Antrean anda saat ini";
  String LayananUtama = "Layanan Utama";
  String LupaPassword = "Lupa Password ?";
  String IngatSaya = "Ingat Saya";
  String LoginSekarang = "Login Sekarang";
  ...
  String RiwayatMedis = "Riwayat \nMedis";
  String ProfilePasien1 = "Profile \nPasien";
}